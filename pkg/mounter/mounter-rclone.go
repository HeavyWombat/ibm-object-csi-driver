...
func NewRcloneMounter(secretMap map[string]string, mountOptions []string, statsUtils utils.VolumeStatsUtils) (Mounter, error) {
...
func (rclone *RcloneMounter) Mount(source string, target string) error {
	...
	return rclone.StatsUtils.FuseMount(target, rcloneCmd, args)
}
